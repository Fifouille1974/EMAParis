...
<h5>Nom de la molécule :</h5>
<p><?php the_title(); ?></p>
<h5>Stade</h5>
<p>
<?php
$terms_as_text = get_the_term_list( $post->ID, 'faqs_cats', '', ', ', '' ) ;
echo strip_tags($terms_as_text);
?>
</p>
<?php the_content(); ?></div>
<div class="one-two-third column-last"><h5>Structure</h5><?php the_post_thumbnail(); ?></div>
<div class="clear"></div>
